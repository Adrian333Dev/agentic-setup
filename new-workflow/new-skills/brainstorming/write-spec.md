...
Write to `docs/work/topics/<slug>/spec.md` — the same topic folder as `brainstorm.md`. Write each section progressively — update the file as each section completes. Never hold the full spec in memory before writing.
...
> "Spec approved. Invoking writing-plans."

**REQUIRED NEXT SKILL:** `superpowers:writing-plans`
